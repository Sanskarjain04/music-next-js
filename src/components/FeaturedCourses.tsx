...
function FeaturedCourses() {
  ...
  return (
    <div className=" py-12 bg-gray-900 min-h-screen w-full">
      <div>
      ...
      <div className="mt-20 text-center">
        <Link
          href={"/Courses"}
          className=" mx-auto px-4 py-2 rounded border border-neutral-600 text-neutral-700 bg-white hover:bg-gray-100 transition duration-200"
        >
          View All Courses
        </Link>
      </div>
